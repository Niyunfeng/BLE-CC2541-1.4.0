/**************************************************************************************************
  Filename:       hal_Eeprom.h
  Revised:        $Date: 2012-08-15 16:58:46 -0700 (Wed, 15 Aug 2012) $
  Revision:       $Revision: 31257 $

  Description:    Interface to the IR temperature sensor driver
  ...
  NON-EepromRINGEMENT AND FITNESS FOR A PARTICULAR PURPOSE. IN NO EVENT SHALL
