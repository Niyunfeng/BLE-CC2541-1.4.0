...
void osal_run_system( void )
{
  ...
  else  // Complete pass through all task events with no activity?
  {
     ...
     // HalLedSet(HAL_LED_1, HAL_LED_MODE_ON );   //¿ªLED1
      
      osal_pwrmgr_powerconserve();  // Put the processor/system into sleep
    /*OSALÏµÍ³ÔÚ¼ì²éÍêËùÓÐµÄÈÎÎñÊÂ¼þÖ®ºó·¢ÏÖÃ»ÓÐÊÂ¼þÐèÒª´¦Àí£¬
    ÕâÑùÔÚPOWER_SAVINGºê¶¨Òå´ò¿ªµÄÇé¿öÏÂ½«µ÷ÓÃosal_pwrmgr_powerconserve();
    º¯Êý£¬ÔÚÕâº¯ÊýÖÐ½«»á¸ù¾ÝÑ¡ÔñÏµÍ³½øÈëÐÝÃß¡£*/
  }
#endif
