...
typedef struct
{
  uint16 pwrmgr_task_state;//  ÈÎÎñ×´Ì¬
  uint16 pwrmgr_next_timeout;//ÏÂÒ»´Î³¬Ê±
  uint16 accumulated_sleep_time;//Ë¯ÃßÊ±¼ä
  uint8  pwrmgr_device;//µçÔ´¹ÜÀíÉè±¸ÊôÐÔ£¬ÓÐPWRMGR_ALWAYS_ON PWRMGR_BATTERYÁ½ÖÖ
} pwrmgr_attribute_t;
...
Ñ¡ÔñPWRMGR_ALWAYS_ONµÄ»°½«²»»á½øÈëË¯ÃßÄ£Ê½£¬
Ñ¡ÔñPWRMGR_BATTERY½«ÔÊÐíHAL¹ÜÀíCPU½øÈëSLEEP LITE»òÕßSLEEP DEEP×´Ì¬¡£
 */
...
µÍ¹¦ºÄ±êÖ¾£¬Ö÷ÒªÓÃÓÚosal_pwrmgr_task_state()Õâ¸öº¯ÊýÖÐ£¬ÓÃÓÚ±êÖ¾Ã¿Ò»ÈÎÎñÊÇ·ñÐèÒªµÍ¹¦ºÄ¡£
 */
